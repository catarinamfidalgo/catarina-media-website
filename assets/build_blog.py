...
<link rel="stylesheet" href="{root}assets/site.css?v=b0dbc202">
  ...
  <div class="container">
    <header class="site">
      <div class="brand-block">
        ...
        <svg class="brand-bunny" viewBox="0 0 28 42" aria-hidden="true" focusable="false">
          <g fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M8 20C5.5 13 6 5 9 1.5 12-1 14 3 13.3 9c-.7 5-2.1 9-2.8 11.5"/>
            <path d="M17.5 20.5c0-7.5 2-14.5 5.5-17 3.5-2 4.2 2.5 2 7.5s-4.5 8-5.2 10"/>
            <path d="M5 30c0-6 4-9.5 9-9.5s9 3.5 9 9.5c0 5.5-3.5 8-9 8s-9-2.5-9-8Z"/>
            <path d="M14 31v1.4M14 32.4c-1 1-2 .7-2.3-.1M14 32.4c1 1 2 .7 2.3-.1"/>
            <path d="M6.5 37c-.5 3 1.5 4.5 3.5 3.8M21.5 37c.5 3-1.5 4.5-3.5 3.8"/>
          </g>
          <circle cx="10.6" cy="28.5" r="1.2" fill="currentColor"/>
          <circle cx="17.4" cy="28.5" r="1.2" fill="currentColor"/>
        </svg>
      </div>
